...
import { getAreaWiseBicholiyaForCandidate, getAreawiseCandidateForBicholiya, getBicholiyaAnalyticsData, getBicholiyaList, getBiodataStatusWise, updateBioDataStatus } from "@/controllers/matrimony/bicholiya.matrimony.controllers";
